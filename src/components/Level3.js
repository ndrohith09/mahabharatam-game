  ...
  return (
    <div className="Instructionpage">
      <div className="contentbox">
        <h1> <FcAbout /> INSTRUCTIONS for LEVEL-3</h1>
        <br />
      ...
      <div className="instruct">
          ...
          <h3>	In order to gain weapons you have to gain minimum 80 <FcRating /> coins 10 <GrDiamond /> diamonds.</h3>
      </div>
      <br />
      <Table striped bordered hover>
        <thead>
      ...
      <br />      
        <div className="instruct">
          ...
          <h3>Where you will have some life line with 90% and you have to fight with enemies and by defeating them you can reach the final enemy for the Level 3</h3>
          <h3>After that you will be promoted to the next Level-4</h3>
         
        </div>
        <a href="/quiz3">Start Battle <GiShieldBash style={{color:"black"}}/> </a>
      </div>
    </div>
  );
}
